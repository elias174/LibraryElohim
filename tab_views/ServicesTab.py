...
class ServicesTab(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.button_print_report = QtGui.QPushButton("Imprimir Reporte")
        self.button_new_service_payment = QtGui.QPushButton(
            "Nuevo Pago Servicio")

        self.button_add_payment.setMinimumWidth(
            self.screenGeometry.width() / 6)
        self.button_print_report.setMinimumWidth(
            self.screenGeometry.width() / 6)
        ...
        self.layout_buttons_results.addWidget(self.button_print_report)
