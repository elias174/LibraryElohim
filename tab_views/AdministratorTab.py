...
class Administrator_Tab(QtGui.QWidget):
    ...
    def initialize_search_group(self):
        ...
        self.search_bill_today.setToolTip("Buscar en Todas las Facturas que se realizaron hoy")
        self.search_bill_name = QRadioButton("Buscar Factura por ID")
        self.search_bill_name.setToolTip("Buscar en Todas las Facturas pero por su ID")
